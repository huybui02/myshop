        ...
        return (
            <View style={wrapper}>
                <View style={mapContainer}>
                    <MapView
                        style={{ width: width - 20, height: 220 }}
                        initialRegion={{
                            latitude: 37.78825,
                            longitude: -122.4324,
                    ...
                    >
                        <MapView.Marker
                            ...
                            title="My Shop"
                            description="Shop tui o day ne! :D"
                        />
                    </MapView>
                </View>
                <View style={infoContainer}>
                    <View style={rowInfoContainer}>
                        ...
                        <Text style={infoText}>Tan Luoc - Binh Tan - Vinh Long</Text>
                    </View>
                    <View style={rowInfoContainer}>
                        <Image source={phoneIcon} style={imageStyle} />
                        <Text style={infoText}>(+84) 01867279217</Text>
                    </View>
                    <View style={rowInfoContainer}>
                        <Image source={mailIcon} style={imageStyle} />
                        <Text style={infoText}>huyb1304842@student.ctu.edu.vn</Text>
                    </View>
